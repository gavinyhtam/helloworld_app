# Module used to convert country names (say via FB) to ID codes
# readable by AmMaps javascript

module LocationCode
	#converts country name to AmMaps code
	def code(location_name)
		case location_name
			...
			when "Bonaire Saint Eustachius and Saba"	then "BQ"
			when "Brazil"	then "BR"
			...
			when "Gambia"	then "GM"
			when "Guinea"	then "GN"
			when "Glorioso Islands"	then "GO"
			when "Guadeloupe"	then "GP"
			when "Equatorial Guinea"	then "GQ"
			when "Greece"	then "GR"
			when "South Georgia and South Sandwich Islands"	then "GS"
			...
			when "Jordan"	then "JO"
			when "Japan"	then "JP"
			when "Juan De Nova Island"	then "JU"
			when "Kenya"	then "KE"
			...
			when "Uganda"	then "UG"
			when "Jarvis Island"	then "UM_DQ"
			when "Baker Island"	then "UM_FQ"
			when "Howland Island"	then "UM_HQ"
			when "Johnston Atoll"	then "UM_JQ"
			when "Midway Islands"	then "UM_MQ"
			when "Wake Island"	then "UM_WQ"
			...
			when "British Virgin Islands"	then "VG"
	...
	#converts AmMaps code to country name
	def country(code)
		case code
